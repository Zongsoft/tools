...
- 重构进度以 [REFACTOR-TASKS.md](REFACTOR-TASKS.md) 为准，回归记录见 [.testagent/status.md](.testagent/status.md)。测试项目在 test/，支持 net8.0/net9.0/net10.0；避免通过 Cake 发布任务验证。
...
- 实现变化同步 docs 中英文文档、双语 README 入口、SKILL 与任务清单；打包时检查文档和上游许可证均随包分发。
